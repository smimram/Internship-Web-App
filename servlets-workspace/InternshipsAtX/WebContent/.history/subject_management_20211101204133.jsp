							...
							<c:forEach items="${subjects}" var="subject">
								<li class="table-row">
									...
									<div class="col col-1">
										...
										<button type="button" class="btn btn-primary btn-sm" ${(subject.dateFiche != null) ? 'title="Last update: "'+subject.dateFiche : 'title="No file"'}><a href="/InternshipsAtX/download-fiche?internshipId=${subject.id}" target="_blank" style="color: white">Download fiche de stage</a></button>
										<button type="button" class="btn btn-primary btn-sm" ${(subject.dateReport != null) ? 'title="Last update: "'+subject.dateReport : 'title="No file"'}><a href="/InternshipsAtX/download-report?internshipId=${subject.id}" target="_blank" style="color: white">Download report</a></button>
										<button type="button" class="btn btn-primary btn-sm" ${(subject.dateSlides != null) ? 'title="Last update: "'+subject.dateSlides : 'title="No file"'}><a href="/InternshipsAtX/download-slides?internshipId=${subject.id}" target="_blank" style="color: white">Download slides</a></button>
