							...
							<li class="table-row">
								...
								<div class="col col-1" data-label="Report">
									<form method="post" action="upload-report" enctype="multipart/form-data">
										...
										<input type="file" id="selectedFile" accept="application/pdf" title="Please upload your report in PDF format." hidden />
										<input name="report" type="button" value="Browse..." onclick="document.getElementById('selectedFile').click();" onchange="this.form.submit()"/>
									</form>
									<div class="col col-1" data-label="Report">
								...
								<div class="col col-1" data-label="Slides">
									<form method="post" action="upload-slides" enctype="multipart/form-data">
										<input name="subjectId" value="<%=subject.getId()%>" hidden />
										<input name="userId" value="<%=user.getId()%>" hidden />
										<input id="slides" type="file" name="fiche" accept="application/pdf" title="Please upload your slides in PDF format." onchange="this.form.submit()"/>
									</form>
									<div class="col col-1" data-label="Slides">
