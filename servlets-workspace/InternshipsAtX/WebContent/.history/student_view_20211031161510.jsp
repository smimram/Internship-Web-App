						...
						<ul class="responsive-table">
							...
							<li class="table-row">
								...
								<div class="col col-1" data-label="Fiche de stage">
									...
									<div class="col col-1">
										<button type="button" class="btn btn-secondary btn-sm"><a href="/InternshipsAtX/download-fiche?internshipId=<%=subject.getId()%>" target="_blank">Download fiche</a></button>
									</div>
								</div>
