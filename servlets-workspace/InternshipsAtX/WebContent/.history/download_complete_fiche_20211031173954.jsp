			...
			<div class="wrap-login100-V2">
					...
					<form class="login100-form validate-form p-l-55 p-r-55 p-t-178">
						<span class="login100-form-title">
							<h1>Download fiche of internship of "${subjectTitle}"</h1>
						</span>
					</form>
					
					<form>
						<span class="subtitle" style="color:black;"> <h4> <br> <br> Did not work ? <br> 
						<a class="subtitle" style="color:black;" href="/InternshipsAtX/download-fiche?internshipId=${internshipId}">Try again here</a>
						 </h4> <br> <br> </span>
					</form>
