									...
									<ul class="responsive-table">
										...
										<li class="table-row">
											...
											<div class="col col-1" data-label="Fiche de stage">
												<button id="uploadFiche" type="file" name="uploadFiche" accept="application/pdf" title="Please upload your fiche de stage in PDF format.">Upload fiche de stage</button>
											</div>
											<div class="col col-1" data-label="Report">
												<button id="uploadReport" type="file" name="uploadReport" accept="application/pdf" title="Please upload your report in PDF format.">Upload report</button>
											</div>
