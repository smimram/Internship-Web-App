									...
									<ul class="responsive-table">
										...
										<li class="table-row">
											...
											<div class="col col-1" data-label="Fiche de stage">
												<form>
													<label>Upload fiche de stage</label>
													<input id="uploadFiche" type="file" name="uploadFiche" accept="application/pdf" title="Please upload your fiche de stage in PDF format." onchange="uploadFileFiche();">
												</form>
											</div>
											<div class="col col-1" data-label="Report">
												<form>
													<label>Upload report</label>
													<input id="uploadReport" type="file" name="uploadReport" accept="application/pdf" title="Please upload your report in PDF format." onchange="uploadFileReport();">Upload report</button>
												</form>
											</div>
											<div class="col col-1" data-label="Slides">
												<form>
													<label>Upload slides</label>
													<input id="uploadSlides" type="file" name="uploadSlides" accept="application/pdf" title="Please upload your slides in PDF format." onchange="uploadFileSlides();">Upload slides</button>
												</form>
											</div>
