						...
						<ul class="responsive-table">
							...
							<c:forEach items="${subjects}" var="subject">
								<li class="table-row">
									...
									<div class="col col-1">
										<button type="button" class="btn btn-sm"><a href="/InternshipsAtX/download-subject?internshipId=${subject.id}" target="_blank">Download subject</a></button>
										<button type="button" class="btn btn-sm"><a href="/InternshipsAtX/download-fiche?internshipId=${subject.id}" target="_blank">Download fiche de stage</a></button>
										<button type="button" class="btn  btn-sm"><a href="/InternshipsAtX/download-report?internshipId=${subject.id}" target="_blank">Download report</a></button>
										<button type="button" class="btn btn-sm"><a href="/InternshipsAtX/download-slides?internshipId=${subject.id}" target="_blank">Download slides</a></button>
