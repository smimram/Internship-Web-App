							...
							<li class="table-row">
								...
								<div class="col col-1" data-label="Fiche de stage">
									<form method="post" action="upload-fiche" enctype="multipart/form-data">
										<input name="subjectId" value="<%=subject.getId()%>" style="opacity: 100;"/>
										<input name="userId" value="<%=user.getId()%>" style="opacity: 0;"/>
										<input id="fiche" type="file" name="fiche" accept="application/pdf" title="Please upload your fiche de stage in PDF format."/>
										<button type=submit>Upload</button>
									</form>
									<div class="col col-1">
										<button type="button" class="btn btn-secondary btn-sm"><a href="/InternshipsAtX/download-subject?internshipId=<%=subject.getId()%>" target="_blank">Download subject</a></button>
									</div>
								</div>
								...
								<div class="col col-1" data-label="Slides">
									<form method="post" action="upload-slides" enctype="multipart/form-data">
										<input id="slides" type="file" name="slides" accept="application/pdf" title="Please upload your slides in PDF format."/>
										<button type=submit>Upload</button>
									</form>
									<div class="col col-1">
