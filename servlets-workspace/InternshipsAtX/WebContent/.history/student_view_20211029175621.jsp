										...
										<li class="table-row">
											...
											<div class="col col-1" data-label="Fiche de stage">
												<form method="post" action="upload-fiche" enctype="multipart/form-data">
													...
													<input id="uploadFiche" type="file" name="uploadFiche" accept="application/pdf" title="Please upload your fiche de stage in PDF format.">
												</form>
											</div>
											<div class="col col-1" data-label="Report">
												<form method="post" action="upload-report" enctype="multipart/form-data">
													<label>Upload report</label>
													<input id="uploadReport" type="file" name="uploadReport" accept="application/pdf" title="Please upload your report in PDF format.">Upload report</button>
												</form>
											</div>
											<div class="col col-1" data-label="Slides">
												<form method="post" action="upload-slides" enctype="multipart/form-data">
													...
													<input id="uploadSlides" type="file" name="uploadSlides" accept="application/pdf" title="Please upload your slides in PDF format.">Upload slides</button>
												</form>
											</div>
