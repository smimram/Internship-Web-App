							...
							<c:forEach items="${subjects}" var="subject">
								<li class="table-row">
									...
									<div class="col col-1">
										...
										<button type="button" class="btn btn-primary btn-sm" title="${(subject.dateFiche != null) ? 'Last update: 'subject.dateFiche : 'No file'}"><a href="/InternshipsAtX/download-fiche?internshipId=${subject.id}" target="_blank" style="color: white">Download fiche de stage</a></button>
										<button type="button" class="btn btn-primary btn-sm" title="${(subject.dateReport != null) ? 'Last update: 'subject.dateReport : 'No file'}"><a href="/InternshipsAtX/download-report?internshipId=${subject.id}" target="_blank" style="color: white">Download report</a></button>
										<button type="button" class="btn btn-primary btn-sm" title="${(subject.dateSlides != null) ? 'Last update: 'subject.dateSlides : 'No file'}"><a href="/InternshipsAtX/download-slides?internshipId=${subject.id}" target="_blank" style="color: white">Download slides</a></button>
