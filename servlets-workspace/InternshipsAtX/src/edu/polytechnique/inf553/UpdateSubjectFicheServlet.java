 ...
 */
@WebServlet("/UpdateSubjectFicheServlet")
public class UpdateSubjectFicheServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateSubjectFicheServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session!=null && session.getAttribute("user")!= null) {
			...
			if (role.equals("Admin") || role.equals("Professor")) {
				Part uploadFiche = request.getPart("uploadFiche");
				...
				try {
					...
					String query = "START TRANSACTION ISOLATION LEVEL SERIALIZABLE;\r\n" + 
							"UPDATE internship SET fiche_stage = ?\r\n" +
							"WHERE id = ?;\r\n" + 
