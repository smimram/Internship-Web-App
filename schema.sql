...
-- UPDATE program SET description = "Data Science" WHERE name = 'INF592';
-- UPDATE program SET description = "Computer Science" WHERE name = 'INF591';
-- UPDATE program SET description = "Computer Vision" WHERE name = 'INF594';